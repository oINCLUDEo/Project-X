...
from telethon_client.handlers.handler_utils import engagement_publisher_task, reputation_refresher_task, cluster_lifecycle_manager_task, user_queue_processor_task
...
async def main():
    ...
    queue_processor = asyncio.create_task(user_queue_processor_task(bot))
    ...
    await asyncio.gather(telethon_task, aiogram_task, publisher, queue_processor, reputation, lifecycle)
